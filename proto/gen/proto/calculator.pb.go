...
func (x *Request) GetNumber1() int32 {
	if x != nil {
		return x.Number1
	}
	return 0
...
func (x *Request) GetNumber2() int32 {
	if x != nil {
		return x.Number2
	}
	return 0
...
var file_proto_calculator_proto_rawDesc = []byte{
	...
	0x3d, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x6e, 0x75,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x32, 0x22, 0x22,
	...
	0x6c, 0x74, 0x32, 0x34, 0x0a, 0x0a, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72,
...
var file_proto_calculator_proto_depIdxs = []int32{
	0, // 0: proto.Calculator.Add:input_type -> proto.Request
	1, // 1: proto.Calculator.Add:output_type -> proto.Response
